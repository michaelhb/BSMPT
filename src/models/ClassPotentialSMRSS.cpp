...
void Class_Potential_SMRSS::SetCurvatureArrays(){
   ...
   */
    ...
    Curvature_Quark_F2H1[0][1][2] = 2*std::sqrt(2)*Yu(0,0);
    Curvature_Quark_F2H1[0][1][3] = (-2.0*II)*std::sqrt(2)*Yu(0,0);
    Curvature_Quark_F2H1[0][3][0] = 2*std::sqrt(2)*Yd(0,0);
    Curvature_Quark_F2H1[0][3][1] = (2.0*II)*std::sqrt(2)*Yd(0,0);
    Curvature_Quark_F2H1[0][5][2] = 2*std::sqrt(2)*Yu(0,1);
    Curvature_Quark_F2H1[0][5][3] = (-2.0*II)*std::sqrt(2)*Yu(0,1);
    Curvature_Quark_F2H1[0][7][0] = 2*std::sqrt(2)*Yd(0,1);
    Curvature_Quark_F2H1[0][7][1] = (2.0*II)*std::sqrt(2)*Yd(0,1);
    Curvature_Quark_F2H1[0][9][2] = 2*std::sqrt(2)*Yu(0,2);
    Curvature_Quark_F2H1[0][9][3] = (-2.0*II)*std::sqrt(2)*Yu(0,2);
    Curvature_Quark_F2H1[0][11][0] = 2*std::sqrt(2)*Yd(0,2);
    Curvature_Quark_F2H1[0][11][1] = (2.0*II)*std::sqrt(2)*Yd(0,2);
    Curvature_Quark_F2H1[1][0][2] = 2*std::sqrt(2)*Yu(0,0);
    Curvature_Quark_F2H1[1][0][3] = (-2.0*II)*std::sqrt(2)*Yu(0,0);
    Curvature_Quark_F2H1[1][2][0] = -2*std::sqrt(2)*Yu(0,0);
    Curvature_Quark_F2H1[1][2][1] = (2.0*II)*std::sqrt(2)*Yu(0,0);
    Curvature_Quark_F2H1[1][4][2] = 2*std::sqrt(2)*Yu(1,0);
    Curvature_Quark_F2H1[1][4][3] = (-2.0*II)*std::sqrt(2)*Yu(1,0);
    Curvature_Quark_F2H1[1][6][0] = -2*std::sqrt(2)*Yu(1,0);
    Curvature_Quark_F2H1[1][6][1] = (2.0*II)*std::sqrt(2)*Yu(1,0);
    Curvature_Quark_F2H1[1][8][2] = 2*std::sqrt(2)*Yu(2,0);
    Curvature_Quark_F2H1[1][8][3] = (-2.0*II)*std::sqrt(2)*Yu(2,0);
    Curvature_Quark_F2H1[1][10][0] = -2*std::sqrt(2)*Yu(2,0);
    Curvature_Quark_F2H1[1][10][1] = (2.0*II)*std::sqrt(2)*Yu(2,0);
    Curvature_Quark_F2H1[2][1][0] = -2*std::sqrt(2)*Yu(0,0);
    Curvature_Quark_F2H1[2][1][1] = (2.0*II)*std::sqrt(2)*Yu(0,0);
    Curvature_Quark_F2H1[2][3][2] = 2*std::sqrt(2)*Yd(0,0);
    Curvature_Quark_F2H1[2][3][3] = (2.0*II)*std::sqrt(2)*Yd(0,0);
    Curvature_Quark_F2H1[2][5][0] = -2*std::sqrt(2)*Yu(0,1);
    Curvature_Quark_F2H1[2][5][1] = (2.0*II)*std::sqrt(2)*Yu(0,1);
    Curvature_Quark_F2H1[2][7][2] = 2*std::sqrt(2)*Yd(0,1);
    Curvature_Quark_F2H1[2][7][3] = (2.0*II)*std::sqrt(2)*Yd(0,1);
    Curvature_Quark_F2H1[2][9][0] = -2*std::sqrt(2)*Yu(0,2);
    Curvature_Quark_F2H1[2][9][1] = (2.0*II)*std::sqrt(2)*Yu(0,2);
    Curvature_Quark_F2H1[2][11][2] = 2*std::sqrt(2)*Yd(0,2);
    Curvature_Quark_F2H1[2][11][3] = (2.0*II)*std::sqrt(2)*Yd(0,2);
    Curvature_Quark_F2H1[3][0][0] = 2*std::sqrt(2)*Yd(0,0);
    Curvature_Quark_F2H1[3][0][1] = (2.0*II)*std::sqrt(2)*Yd(0,0);
    Curvature_Quark_F2H1[3][2][2] = 2*std::sqrt(2)*Yd(0,0);
    Curvature_Quark_F2H1[3][2][3] = (2.0*II)*std::sqrt(2)*Yd(0,0);
    Curvature_Quark_F2H1[3][4][0] = 2*std::sqrt(2)*Yd(1,0);
    Curvature_Quark_F2H1[3][4][1] = (2.0*II)*std::sqrt(2)*Yd(1,0);
    Curvature_Quark_F2H1[3][6][2] = 2*std::sqrt(2)*Yd(1,0);
    Curvature_Quark_F2H1[3][6][3] = (2.0*II)*std::sqrt(2)*Yd(1,0);
    Curvature_Quark_F2H1[3][8][0] = 2*std::sqrt(2)*Yd(2,0);
    Curvature_Quark_F2H1[3][8][1] = (2.0*II)*std::sqrt(2)*Yd(2,0);
    Curvature_Quark_F2H1[3][10][2] = 2*std::sqrt(2)*Yd(2,0);
    Curvature_Quark_F2H1[3][10][3] = (2.0*II)*std::sqrt(2)*Yd(2,0);
    Curvature_Quark_F2H1[4][1][2] = 2*std::sqrt(2)*Yu(1,0);
    Curvature_Quark_F2H1[4][1][3] = (-2.0*II)*std::sqrt(2)*Yu(1,0);
    Curvature_Quark_F2H1[4][3][0] = 2*std::sqrt(2)*Yd(1,0);
    Curvature_Quark_F2H1[4][3][1] = (2.0*II)*std::sqrt(2)*Yd(1,0);
    Curvature_Quark_F2H1[4][5][2] = 2*std::sqrt(2)*Yu(1,1);
    Curvature_Quark_F2H1[4][5][3] = (-2.0*II)*std::sqrt(2)*Yu(1,1);
    Curvature_Quark_F2H1[4][7][0] = 2*std::sqrt(2)*Yd(1,1);
    Curvature_Quark_F2H1[4][7][1] = (2.0*II)*std::sqrt(2)*Yd(1,1);
    Curvature_Quark_F2H1[4][9][2] = 2*std::sqrt(2)*Yu(1,2);
    Curvature_Quark_F2H1[4][9][3] = (-2.0*II)*std::sqrt(2)*Yu(1,2);
    Curvature_Quark_F2H1[4][11][0] = 2*std::sqrt(2)*Yd(1,2);
    Curvature_Quark_F2H1[4][11][1] = (2.0*II)*std::sqrt(2)*Yd(1,2);
    Curvature_Quark_F2H1[5][0][2] = 2*std::sqrt(2)*Yu(0,1);
    Curvature_Quark_F2H1[5][0][3] = (-2.0*II)*std::sqrt(2)*Yu(0,1);
    Curvature_Quark_F2H1[5][2][0] = -2*std::sqrt(2)*Yu(0,1);
    Curvature_Quark_F2H1[5][2][1] = (2.0*II)*std::sqrt(2)*Yu(0,1);
    Curvature_Quark_F2H1[5][4][2] = 2*std::sqrt(2)*Yu(1,1);
    Curvature_Quark_F2H1[5][4][3] = (-2.0*II)*std::sqrt(2)*Yu(1,1);
    Curvature_Quark_F2H1[5][6][0] = -2*std::sqrt(2)*Yu(1,1);
    Curvature_Quark_F2H1[5][6][1] = (2.0*II)*std::sqrt(2)*Yu(1,1);
    Curvature_Quark_F2H1[5][8][2] = 2*std::sqrt(2)*Yu(2,1);
    Curvature_Quark_F2H1[5][8][3] = (-2.0*II)*std::sqrt(2)*Yu(2,1);
    Curvature_Quark_F2H1[5][10][0] = -2*std::sqrt(2)*Yu(2,1);
    Curvature_Quark_F2H1[5][10][1] = (2.0*II)*std::sqrt(2)*Yu(2,1);
    Curvature_Quark_F2H1[6][1][0] = -2*std::sqrt(2)*Yu(1,0);
    Curvature_Quark_F2H1[6][1][1] = (2.0*II)*std::sqrt(2)*Yu(1,0);
    Curvature_Quark_F2H1[6][3][2] = 2*std::sqrt(2)*Yd(1,0);
    Curvature_Quark_F2H1[6][3][3] = (2.0*II)*std::sqrt(2)*Yd(1,0);
    Curvature_Quark_F2H1[6][5][0] = -2*std::sqrt(2)*Yu(1,1);
    Curvature_Quark_F2H1[6][5][1] = (2.0*II)*std::sqrt(2)*Yu(1,1);
    Curvature_Quark_F2H1[6][7][2] = 2*std::sqrt(2)*Yd(1,1);
    Curvature_Quark_F2H1[6][7][3] = (2.0*II)*std::sqrt(2)*Yd(1,1);
    Curvature_Quark_F2H1[6][9][0] = -2*std::sqrt(2)*Yu(1,2);
    Curvature_Quark_F2H1[6][9][1] = (2.0*II)*std::sqrt(2)*Yu(1,2);
    Curvature_Quark_F2H1[6][11][2] = 2*std::sqrt(2)*Yd(1,2);
    Curvature_Quark_F2H1[6][11][3] = (2.0*II)*std::sqrt(2)*Yd(1,2);
    Curvature_Quark_F2H1[7][0][0] = 2*std::sqrt(2)*Yd(0,1);
    Curvature_Quark_F2H1[7][0][1] = (2.0*II)*std::sqrt(2)*Yd(0,1);
    Curvature_Quark_F2H1[7][2][2] = 2*std::sqrt(2)*Yd(0,1);
    Curvature_Quark_F2H1[7][2][3] = (2.0*II)*std::sqrt(2)*Yd(0,1);
    Curvature_Quark_F2H1[7][4][0] = 2*std::sqrt(2)*Yd(1,1);
    Curvature_Quark_F2H1[7][4][1] = (2.0*II)*std::sqrt(2)*Yd(1,1);
    Curvature_Quark_F2H1[7][6][2] = 2*std::sqrt(2)*Yd(1,1);
    Curvature_Quark_F2H1[7][6][3] = (2.0*II)*std::sqrt(2)*Yd(1,1);
    Curvature_Quark_F2H1[7][8][0] = 2*std::sqrt(2)*Yd(2,1);
    Curvature_Quark_F2H1[7][8][1] = (2.0*II)*std::sqrt(2)*Yd(2,1);
    Curvature_Quark_F2H1[7][10][2] = 2*std::sqrt(2)*Yd(2,1);
    Curvature_Quark_F2H1[7][10][3] = (2.0*II)*std::sqrt(2)*Yd(2,1);
    Curvature_Quark_F2H1[8][1][2] = 2*std::sqrt(2)*Yu(2,0);
    Curvature_Quark_F2H1[8][1][3] = (-2.0*II)*std::sqrt(2)*Yu(2,0);
    Curvature_Quark_F2H1[8][3][0] = 2*std::sqrt(2)*Yd(2,0);
    Curvature_Quark_F2H1[8][3][1] = (2.0*II)*std::sqrt(2)*Yd(2,0);
    Curvature_Quark_F2H1[8][5][2] = 2*std::sqrt(2)*Yu(2,1);
    Curvature_Quark_F2H1[8][5][3] = (-2.0*II)*std::sqrt(2)*Yu(2,1);
    Curvature_Quark_F2H1[8][7][0] = 2*std::sqrt(2)*Yd(2,1);
    Curvature_Quark_F2H1[8][7][1] = (2.0*II)*std::sqrt(2)*Yd(2,1);
    Curvature_Quark_F2H1[8][9][2] = 2*std::sqrt(2)*Yu(2,2);
    Curvature_Quark_F2H1[8][9][3] = (-2.0*II)*std::sqrt(2)*Yu(2,2);
    Curvature_Quark_F2H1[8][11][0] = 2*std::sqrt(2)*Yd(2,2);
    Curvature_Quark_F2H1[8][11][1] = (2.0*II)*std::sqrt(2)*Yd(2,2);
    Curvature_Quark_F2H1[9][0][2] = 2*std::sqrt(2)*Yu(0,2);
    Curvature_Quark_F2H1[9][0][3] = (-2.0*II)*std::sqrt(2)*Yu(0,2);
    Curvature_Quark_F2H1[9][2][0] = -2*std::sqrt(2)*Yu(0,2);
    Curvature_Quark_F2H1[9][2][1] = (2.0*II)*std::sqrt(2)*Yu(0,2);
    Curvature_Quark_F2H1[9][4][2] = 2*std::sqrt(2)*Yu(1,2);
    Curvature_Quark_F2H1[9][4][3] = (-2.0*II)*std::sqrt(2)*Yu(1,2);
    Curvature_Quark_F2H1[9][6][0] = -2*std::sqrt(2)*Yu(1,2);
    Curvature_Quark_F2H1[9][6][1] = (2.0*II)*std::sqrt(2)*Yu(1,2);
    Curvature_Quark_F2H1[9][8][2] = 2*std::sqrt(2)*Yu(2,2);
    Curvature_Quark_F2H1[9][8][3] = (-2.0*II)*std::sqrt(2)*Yu(2,2);
    Curvature_Quark_F2H1[9][10][0] = -2*std::sqrt(2)*Yu(2,2);
    Curvature_Quark_F2H1[9][10][1] = (2.0*II)*std::sqrt(2)*Yu(2,2);
    Curvature_Quark_F2H1[10][1][0] = -2*std::sqrt(2)*Yu(2,0);
    Curvature_Quark_F2H1[10][1][1] = (2.0*II)*std::sqrt(2)*Yu(2,0);
    Curvature_Quark_F2H1[10][3][2] = 2*std::sqrt(2)*Yd(2,0);
    Curvature_Quark_F2H1[10][3][3] = (2.0*II)*std::sqrt(2)*Yd(2,0);
    Curvature_Quark_F2H1[10][5][0] = -2*std::sqrt(2)*Yu(2,1);
    Curvature_Quark_F2H1[10][5][1] = (2.0*II)*std::sqrt(2)*Yu(2,1);
    Curvature_Quark_F2H1[10][7][2] = 2*std::sqrt(2)*Yd(2,1);
    Curvature_Quark_F2H1[10][7][3] = (2.0*II)*std::sqrt(2)*Yd(2,1);
    Curvature_Quark_F2H1[10][9][0] = -2*std::sqrt(2)*Yu(2,2);
    Curvature_Quark_F2H1[10][9][1] = (2.0*II)*std::sqrt(2)*Yu(2,2);
    Curvature_Quark_F2H1[10][11][2] = 2*std::sqrt(2)*Yd(2,2);
    Curvature_Quark_F2H1[10][11][3] = (2.0*II)*std::sqrt(2)*Yd(2,2);
    Curvature_Quark_F2H1[11][0][0] = 2*std::sqrt(2)*Yd(0,2);
    Curvature_Quark_F2H1[11][0][1] = (2.0*II)*std::sqrt(2)*Yd(0,2);
    Curvature_Quark_F2H1[11][2][2] = 2*std::sqrt(2)*Yd(0,2);
    Curvature_Quark_F2H1[11][2][3] = (2.0*II)*std::sqrt(2)*Yd(0,2);
    Curvature_Quark_F2H1[11][4][0] = 2*std::sqrt(2)*Yd(1,2);
    Curvature_Quark_F2H1[11][4][1] = (2.0*II)*std::sqrt(2)*Yd(1,2);
    Curvature_Quark_F2H1[11][6][2] = 2*std::sqrt(2)*Yd(1,2);
    Curvature_Quark_F2H1[11][6][3] = (2.0*II)*std::sqrt(2)*Yd(1,2);
    Curvature_Quark_F2H1[11][8][0] = 2*std::sqrt(2)*Yd(2,2);
    Curvature_Quark_F2H1[11][8][1] = (2.0*II)*std::sqrt(2)*Yd(2,2);
    Curvature_Quark_F2H1[11][10][2] = 2*std::sqrt(2)*Yd(2,2);
    Curvature_Quark_F2H1[11][10][3] = (2.0*II)*std::sqrt(2)*Yd(2,2);
    
    Curvature_Lepton_F2H1[0][1][2] = 2*std::sqrt(2)*Ye(0,0);
    Curvature_Lepton_F2H1[0][1][3] = (2.0*II)*std::sqrt(2)*Ye(0,0);
    Curvature_Lepton_F2H1[0][4][2] = 2*std::sqrt(2)*Ye(0,1);
    Curvature_Lepton_F2H1[0][4][3] = (2.0*II)*std::sqrt(2)*Ye(0,1);
    Curvature_Lepton_F2H1[0][7][2] = 2*std::sqrt(2)*Ye(0,2);
    Curvature_Lepton_F2H1[0][7][3] = (2.0*II)*std::sqrt(2)*Ye(0,2);
    Curvature_Lepton_F2H1[1][0][2] = 2*std::sqrt(2)*Ye(0,0);
    Curvature_Lepton_F2H1[1][0][3] = (2.0*II)*std::sqrt(2)*Ye(0,0);
    Curvature_Lepton_F2H1[1][2][0] = 2*std::sqrt(2)*Ye(0,0);
    Curvature_Lepton_F2H1[1][2][1] = (2.0*II)*std::sqrt(2)*Ye(0,0);
    Curvature_Lepton_F2H1[1][3][2] = 2*std::sqrt(2)*Ye(1,0);
    Curvature_Lepton_F2H1[1][3][3] = (2.0*II)*std::sqrt(2)*Ye(1,0);
    Curvature_Lepton_F2H1[1][5][0] = 2*std::sqrt(2)*Ye(1,0);
    Curvature_Lepton_F2H1[1][5][1] = (2.0*II)*std::sqrt(2)*Ye(1,0);
    Curvature_Lepton_F2H1[1][6][2] = 2*std::sqrt(2)*Ye(2,0);
    Curvature_Lepton_F2H1[1][6][3] = (2.0*II)*std::sqrt(2)*Ye(2,0);
    Curvature_Lepton_F2H1[1][8][0] = 2*std::sqrt(2)*Ye(2,0);
    Curvature_Lepton_F2H1[1][8][1] = (2.0*II)*std::sqrt(2)*Ye(2,0);
    Curvature_Lepton_F2H1[2][1][0] = 2*std::sqrt(2)*Ye(0,0);
    Curvature_Lepton_F2H1[2][1][1] = (2.0*II)*std::sqrt(2)*Ye(0,0);
    Curvature_Lepton_F2H1[2][4][0] = 2*std::sqrt(2)*Ye(0,1);
    Curvature_Lepton_F2H1[2][4][1] = (2.0*II)*std::sqrt(2)*Ye(0,1);
    Curvature_Lepton_F2H1[2][7][0] = 2*std::sqrt(2)*Ye(0,2);
    Curvature_Lepton_F2H1[2][7][1] = (2.0*II)*std::sqrt(2)*Ye(0,2);
    Curvature_Lepton_F2H1[3][1][2] = 2*std::sqrt(2)*Ye(1,0);
    Curvature_Lepton_F2H1[3][1][3] = (2.0*II)*std::sqrt(2)*Ye(1,0);
    Curvature_Lepton_F2H1[3][4][2] = 2*std::sqrt(2)*Ye(1,1);
    Curvature_Lepton_F2H1[3][4][3] = (2.0*II)*std::sqrt(2)*Ye(1,1);
    Curvature_Lepton_F2H1[3][7][2] = 2*std::sqrt(2)*Ye(1,2);
    Curvature_Lepton_F2H1[3][7][3] = (2.0*II)*std::sqrt(2)*Ye(1,2);
    Curvature_Lepton_F2H1[4][0][2] = 2*std::sqrt(2)*Ye(0,1);
    Curvature_Lepton_F2H1[4][0][3] = (2.0*II)*std::sqrt(2)*Ye(0,1);
    Curvature_Lepton_F2H1[4][2][0] = 2*std::sqrt(2)*Ye(0,1);
    Curvature_Lepton_F2H1[4][2][1] = (2.0*II)*std::sqrt(2)*Ye(0,1);
    Curvature_Lepton_F2H1[4][3][2] = 2*std::sqrt(2)*Ye(1,1);
    Curvature_Lepton_F2H1[4][3][3] = (2.0*II)*std::sqrt(2)*Ye(1,1);
    Curvature_Lepton_F2H1[4][5][0] = 2*std::sqrt(2)*Ye(1,1);
    Curvature_Lepton_F2H1[4][5][1] = (2.0*II)*std::sqrt(2)*Ye(1,1);
    Curvature_Lepton_F2H1[4][6][2] = 2*std::sqrt(2)*Ye(2,1);
    Curvature_Lepton_F2H1[4][6][3] = (2.0*II)*std::sqrt(2)*Ye(2,1);
    Curvature_Lepton_F2H1[4][8][0] = 2*std::sqrt(2)*Ye(2,1);
    Curvature_Lepton_F2H1[4][8][1] = (2.0*II)*std::sqrt(2)*Ye(2,1);
    Curvature_Lepton_F2H1[5][1][0] = 2*std::sqrt(2)*Ye(1,0);
    Curvature_Lepton_F2H1[5][1][1] = (2.0*II)*std::sqrt(2)*Ye(1,0);
    Curvature_Lepton_F2H1[5][4][0] = 2*std::sqrt(2)*Ye(1,1);
    Curvature_Lepton_F2H1[5][4][1] = (2.0*II)*std::sqrt(2)*Ye(1,1);
    Curvature_Lepton_F2H1[5][7][0] = 2*std::sqrt(2)*Ye(1,2);
    Curvature_Lepton_F2H1[5][7][1] = (2.0*II)*std::sqrt(2)*Ye(1,2);
    Curvature_Lepton_F2H1[6][1][2] = 2*std::sqrt(2)*Ye(2,0);
    Curvature_Lepton_F2H1[6][1][3] = (2.0*II)*std::sqrt(2)*Ye(2,0);
    Curvature_Lepton_F2H1[6][4][2] = 2*std::sqrt(2)*Ye(2,1);
    Curvature_Lepton_F2H1[6][4][3] = (2.0*II)*std::sqrt(2)*Ye(2,1);
    Curvature_Lepton_F2H1[6][7][2] = 2*std::sqrt(2)*Ye(2,2);
    Curvature_Lepton_F2H1[6][7][3] = (2.0*II)*std::sqrt(2)*Ye(2,2);
    Curvature_Lepton_F2H1[7][0][2] = 2*std::sqrt(2)*Ye(0,2);
    Curvature_Lepton_F2H1[7][0][3] = (2.0*II)*std::sqrt(2)*Ye(0,2);
    Curvature_Lepton_F2H1[7][2][0] = 2*std::sqrt(2)*Ye(0,2);
    Curvature_Lepton_F2H1[7][2][1] = (2.0*II)*std::sqrt(2)*Ye(0,2);
    Curvature_Lepton_F2H1[7][3][2] = 2*std::sqrt(2)*Ye(1,2);
    Curvature_Lepton_F2H1[7][3][3] = (2.0*II)*std::sqrt(2)*Ye(1,2);
    Curvature_Lepton_F2H1[7][5][0] = 2*std::sqrt(2)*Ye(1,2);
    Curvature_Lepton_F2H1[7][5][1] = (2.0*II)*std::sqrt(2)*Ye(1,2);
    Curvature_Lepton_F2H1[7][6][2] = 2*std::sqrt(2)*Ye(2,2);
    Curvature_Lepton_F2H1[7][6][3] = (2.0*II)*std::sqrt(2)*Ye(2,2);
    Curvature_Lepton_F2H1[7][8][0] = 2*std::sqrt(2)*Ye(2,2);
    Curvature_Lepton_F2H1[7][8][1] = (2.0*II)*std::sqrt(2)*Ye(2,2);
    Curvature_Lepton_F2H1[8][1][0] = 2*std::sqrt(2)*Ye(2,0);
    Curvature_Lepton_F2H1[8][1][1] = (2.0*II)*std::sqrt(2)*Ye(2,0);
    Curvature_Lepton_F2H1[8][4][0] = 2*std::sqrt(2)*Ye(2,1);
    Curvature_Lepton_F2H1[8][4][1] = (2.0*II)*std::sqrt(2)*Ye(2,1);
    Curvature_Lepton_F2H1[8][7][0] = 2*std::sqrt(2)*Ye(2,2);
    Curvature_Lepton_F2H1[8][7][1] = (2.0*II)*std::sqrt(2)*Ye(2,2);
